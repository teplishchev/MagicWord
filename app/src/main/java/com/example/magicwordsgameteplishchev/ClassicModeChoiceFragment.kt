 ...
 * Use the [ClassicModeChoiceFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ClassicModeChoiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_classic_mode_choice, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment ClassicModeChoiceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClassicModeChoiceFragment().apply {
